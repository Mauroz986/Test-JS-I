...
function menosQueNoventa(num) {
  // Devuelve "true" si el argumento de la función "num" es menor gque noventa
  // De lo contrario, devuelve "false"
  // Tu código:
  if (num<90)
  {return true}
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
  return nombre + "Mauro Garlati " + apellido; 
...
isVocal("a"); //Es Vocal
isVocal("j"); //Dato incorrecto
isVocal("test"); //Dato incorrecto
isVocal(""); //Dato incorrecto
 //  
